...
if ($signup_roleVar == lang('distributor')) {
    $signup_role = "Distributor";
}elseif ($signup_roleVar == lang('retailer')) {
    $signup_role = "Retailer";
}elseif ($signup_roleVar == lang('manufacturer')) {
    $signup_role = "Manufacturer";
}
...
if($signup_fullname == null || $signup_username == null || $signup_email == null || $signup_password == null || $signup_cpassword == null){
    ...
    $signup_admin = "1";   
    $signupsql = "INSERT INTO signup (id,Fullname,Username,Email,Password,Userphoto,gender,role,language,admin)
    VALUES( :signup_id, :signup_fullname, :signup_username, :signup_email, :signup_password, :userphoto, :signup_gender, :signup_role, :signup_language, :signup_admin)";
    ...
    $signupsql = "INSERT INTO signup (id,Fullname,Username,Email,Password,Userphoto,gender,role,language)
    VALUES( :signup_id, :signup_fullname, :signup_username, :signup_email, :signup_password, :userphoto, :signup_gender, :signup_role, :signup_language)";
    $query = $conn->prepare($signupsql);
    $query->bindParam(':signup_id', $signup_id, PDO::PARAM_INT);
    $query->bindParam(':signup_fullname', $signup_fullname, PDO::PARAM_STR);
    $query->bindParam(':signup_username', $signup_username, PDO::PARAM_STR);

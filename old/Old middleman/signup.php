...
<head>
    <title><? echo lang('create_new_account'); ?> | MiddleMan</title>
    <meta charset="UTF-8">
    ...
    <div align="center">
        ...
        <!--============[ sign up sec ]============-->
            ...
            <p><select class="login_signup_textfield2" name="role" id="rl">
            <option selected><? echo lang('distributor'); ?></option>
              <option><? echo lang('retailer'); ?></option>
              <option><? echo lang('manufacturer'); ?></option>
                </select></p>
